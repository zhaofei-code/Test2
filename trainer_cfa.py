...
def parse_args():
    ...
    parser.add_argument('--data_path',type=str, default='/home/ssm/zhaofei/CFA_for_anomaly_localization-main/datasets/mvtec_anomaly_detection/mvtec_anomaly_detection')
